...
#     for i in {1..20}
#     do
#         ns 1805051_part2.tcl $n 20 300 1
#         python3 parser.py nodes $n temp.txt trace2.tr 20 $n 20
#     done
#     python3 average.py nodes $n data_prev2.txt
#     > temp.txt
# done
...
#     for i in {1..20}
#     do
#         ns 1805051_part2.tcl 40 $f 300 1
#         python3 parser.py flows $f temp.txt trace2.tr 20 40 20
#     done
#     python3 average.py flows $f data_prev2.txt
#     > temp.txt
# done
...
do
    ...
    python3 average.py tx $tx data_prev2.txt
    > temp.txt
done
...
do
    ...
    for i in {1..20}
    do
        ns 1805051_part2.tcl 40 20 $r 1
        python3 parser.py rate $r temp.txt trace2.tr 20 40 20
    done
    python3 average.py rate $r data_prev2.txt
    > temp.txt
done
